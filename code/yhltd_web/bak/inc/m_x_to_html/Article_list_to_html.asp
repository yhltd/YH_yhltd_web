...
list_block=list_block&"<td width='80%' class='fw_t'><p>·<a href='"&rs_url&"' target='_blank'>"&left(rs("title"),17)&"</a></p></td>"
list_block=list_block&"<td width='20%' class='fw_s'><span>"&year(rs("time"))&"-"&month(rs("time"))&"-"&day(rs("time"))&"</span></td>"
list_block=list_block&"</tr>"
%>
<%
rs.movenext
