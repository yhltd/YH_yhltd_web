...
MorePro_List=MorePro_List&"<div class='albumblock'><div class='inner'><a href='"&rs_url&"' target='_blank' ><img src='/images/up_images/"&rsp("image")&"'  alt='"&rsp("title")&"'/></a><div class='albumtitle'><a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),14)&"</a></div></div></div>"
rsp.movenext
loop
else
