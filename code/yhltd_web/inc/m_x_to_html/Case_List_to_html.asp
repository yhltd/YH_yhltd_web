...
'list_block=list_block&"<div class='CaseBox'>"
'list_block=list_block&"<div class='CaseLeft'>"
list_block=list_block&"<div class='albumblock'><div class='inner'><a href='"&rs_url&"' target='_blank'  title='"&left(rs("title"),39)&"'><img src='/images/up_images/"&rs("image")&"' alt='"&left(rs("title"),39)&"'/></a><div class='albumtitle'><a href='"&rs_url&"' target='_blank'  title='"&left(rs("title"),39)&"'>"&left(rs("title"),30)&"</a></div></div></div>"
'list_block=list_block&"</div>"
'list_block=list_block&"<div class='CaseRight ColorLink'>"
'list_block=list_block&"<h1><a href='"&rs_url&"' target='_blank'  title='"&left(rs("title"),89)&"'>"&left(rs("title"),30)&"</a></h1>"
'list_block=list_block&"<p>"&left(ClearHtml(rs("description")),72)&"...</p>"
'list_block=list_block&"</div>"
